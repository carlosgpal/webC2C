...
class ProductElasticSearchServiceTest {
    ...
    public void testGetProductsElasticByUser() throws IOException {
        List<ProductElastic> productsByUser = productElasticService.getProductsElasticByUser("noterminao");
    }

    @Test
    public void testGetProductsElasticByTags() throws IOException {
        List<ProductElastic> productsByTags = productElasticService.getProductsElasticByTags(List.of("noterminao"));
    }
