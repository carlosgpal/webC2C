...
// import com.c2c.ProductController;
...
// public String saveProduct(@ModelAttribute("product") Product product) throws
// IOException {
...
// productController.updateProduct(product.getIdproduct(), product);
...
// public String showFormForUpdate(@PathVariable(value = "id") String id, Model
...
// public String deleteProduct(@PathVariable(value = "id") String id) throws
// IOException {
